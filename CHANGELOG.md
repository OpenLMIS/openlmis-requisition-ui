...
* [OLMIS-8191](https://openlmis.atlassian.net/browse/OLMIS-8191): Wrap long Remarks and Requested quantity explanation consistently in editable and read-only product grid cells, and cap them to their column length (250 / 255) with a live character counter.
