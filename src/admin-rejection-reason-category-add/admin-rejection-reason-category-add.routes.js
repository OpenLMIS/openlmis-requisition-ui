...
(function() {
    ...
    angular.module('admin-rejection-reason-category-add').config(routes);

    routes.$inject = ['modalStateProvider', 'ADMINISTRATION_RIGHTS'];

    function routes(modalStateProvider, ADMINISTRATION_RIGHTS) {

        modalStateProvider.state('openlmis.administration.rejectionReasonCategories.add', {
            showInNavigation: false,
            label: 'adminRejectionReasonCategory.addRejectionReasonCategory',
            url: '/add',
            ...
            params: {
                rejectionReasonCategoryResolve: undefined
            }
        });
